...
@section('content')
    ...
    <div class="main-sec">
        <div class="main-wrapper">
            ...
            <form action="{{ route('admin.create_users') }}" method="POST" enctype="multipart/form-data" id="create_user_form"
                ...
                <div class="row mc-b-2">
                    <div class="col-lg-8 col-md-8 col-12 col-center">
                        <div class="user-img-wrapper mc-b-3">
                            <figure><img src="{{ asset('images/user-details.png') }}" class="user-details-img"
                                    alt="user-img"></figure>
                            <label for="user-img" class="user-img-btn"><i class="fa fa-camera"></i></label>
                            <input type="file" onchange="readURL(this);" name="avatar" id="user-img" class="d-none"
