                        ...
                        <div class="form-box__body">
                            ...
                            <div class="form-fields">
                                ...
                                <div class="multiple-upload" data-upload-multiple>
                                    <input type="file" class="gallery-input d-none" multiple data-upload-multiple-input
                                        accept="image/*" id="gallery">
                                ...
                                <div class="col-md-7">
                                    <div class="form-fields">
                                        ...
                                        <select name="is_seo_index" class="field" required
                                            ...
                                            <option {{ old('is_seo_index') == '1' ? 'selected' : '' }} value="1"
                                                selected>Yes</option>
                                            <option {{ old('is_seo_index') == '0' ? 'selected' : '' }} value="0">No
                                            </option>
                                        </select>
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link text-dark" id="profile-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="profile" aria-selected="false">Share
                                                    Facebook</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link text-dark" id="canonical-tab"
                                                    data-bs-toggle="tab" data-bs-target="#canonical" type="button"
                                                    role="tab" aria-controls="canonical"
                                                        ...
                                                        <div class="form-fields col-md-4">
                                                            ...
                                                            <div class="upload" data-upload>
                                                                ...
                                                                <div class="text-danger d-none mt-2 text-center"
                                                                    data-error-message>Please upload a valid image file
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-fields col-md-12">
                                                            ...
                                                            <input type="url" name="canonical" class="field"
                                                                value="{{ old('canonical') }}" placeholder="Enter URL"
                                                                required>
                                                            @error('canonical')
                                                                <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                ...
                <div class="col-md-3">
                        ...
                        <div class="form-box__body">
                            <div class="form-fields">
                                ...
                                <div class="upload" data-upload>
                                    <div class="upload-box-wrapper">
                                        <div class="upload-box show" data-upload-box>
                                            <input type="file" name="blog_featured_image" id="blog_featured_image"
                                                class="upload-box__file d-none" accept="image/*" data-file-input>
                                            <div class="upload-box__placeholder"><i class='bx bxs-image'></i></div>
                                            <label for="blog_featured_image" class="upload-box__btn themeBtn">Upload
                                                Image</label>
                                        </div>
                                        <div class="upload-box__img" data-upload-img>
                                            <button class="delete-btn" data-delete-btn><i
                                    ...
                                    <div class="text-danger d-none mt-2 text-center" data-error-message>Please upload a
                                        valid image file
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-box__body">
                            <div class="form-fields">
                                ...
                                <select name="top_highlighted_tour_id" class="choice-select"placeholder="Select Tour">
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-box__body">
                            <div class="form-fields">
                                <label class="title">Tours <span class="text-danger">*</span> :</label>
                                <select name="featured_tours_ids[]" multiple class="choice-select" data-max-items="4"
