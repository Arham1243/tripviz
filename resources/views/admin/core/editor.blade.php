        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="adminuploadImageBody">
                ...
                <div class="text-center">
                    <input type="button" id="normal_admin_ajax_image_upload" class="btn btn-success" value="Upload"
                        onclick="UploadFile('adminuploadAjax',$('#adminuploadAjaxInput').val()+'|'+$('#imageinlinewidth').val()+'|'+$('#imageinlineheight').val())" />
                </div>
                            ...
                            <div class="text-center">
                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        ...
                                        <input
                                            onclick="updateContet($('#yruxcontentEditorkey').val(),CKEDITOR.instances['yruxcontentEditorta'].getData());"
                                            class="btn btn-lg btn-primary btn-block" value="Update Content"
                                            type="submit" id="normalEditor">
                                        <input
                                            onclick="updatePageContent($('#yruxcontentEditorkey').val(),CKEDITOR.instances['yruxcontentEditorta'].getData(),this)"
                                            data-table="" data-col="" class="btn btn-lg btn-primary btn-block"
                                            value="Update Content" type="submit" id="tableEditor">
                                    </fieldset>
                                </div>
                            </div>
                        </div>
