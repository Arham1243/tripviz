        ...
        <div class="col-md-12 mb-4">
            <div class="form-fields">
                ...
                <input type="text" value="{{ $sectionContent->see_more_text ?? '' }}" name="content[see_more_text]"
                    class="field" placeholder="" data-error="View More Text">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-fields">
                ...
                <div class="field color-picker" data-color-picker-container>
                    ...
                    <input id="color-picker" type="text" name="content[see_more_background_color]"
                        data-color-picker-input value="{{ $sectionContent->see_more_background_color ?? '#ffffff' }}"
                        ...
                        <div class="form-fields">
                            ...
                            <div class="field color-picker" data-color-picker-container>
                                ...
                                <input id="color-picker" type="text" name="content[normal_background_color]"
                                    ...
                                    value="{{ $sectionContent->normal_background_color ?? '' }}" placeholder="#000000"
