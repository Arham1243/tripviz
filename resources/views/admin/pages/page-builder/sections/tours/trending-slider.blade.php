...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="form-fields">
            <label class="title">Select Tours <span class="text-danger">*</span> :</label>
            <select name="content[tour_ids][]" multiple class="field select2-select" placeholder="Select Tours"
