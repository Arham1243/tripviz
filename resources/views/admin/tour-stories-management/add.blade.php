...
@section('content')
    ...
    <div class="main-sec">
        <div class="main-wrapper">
            ...
            <form action="{{ route('admin.tour-stories.store') }}" method="POST" enctype="multipart/form-data"
                class="main-form">
                @csrf
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="estimated_read_time" class="form-control"
                                placeholder="Enter Read Time" required value="{{ old('estimated_read_time') }}">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea id="long_desc" class="form-control ckeditor" name="long_desc">{!! $tour->long_desc ?? '' !!}</textarea>
                            @error('long_desc')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
