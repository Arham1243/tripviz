...
@section('content')
 ...
 <div class="col-lg-8 col-md-8 col-12 col-center">
                        <div class="user-img-wrapper mc-b-3">
                            <figure class="">
                                <a href="{{ $user->avatar ?? asset('admin/assets/images/placeholder.png') }}" data-fancybox="gallery">
                    ...
                    @php
                        $columns_to_ignore = ["avatar","social_id","social_token","email_verified","is_active","email_verification_token"];
                        $files_columns = [];
                    @endphp
