    ...
    <nav aria-label="breadcrumb">
        ...
        <div class="row pt-3">
            <div class="col-md-3">
                <div class="main-blog__card">
                    <a href="{{ route("blog-details") }}" class="blog__card-img">
                        <img src="{{ asset("assets/images/burj-al-arab.webp") }}" alt='image' class='imgFluid' loading='lazy'>
                    </a>
            ...
            <div class="col-md-3">
                <div class="main-blog__card">
                    <a href="{{ route("blog-details") }}" class="blog__card-img">
                        <img src="{{ asset("assets/images/e52a77e594ec4305d911409cb9acbca98b39e56fb8ee04077565e8ecdb57492b.webp") }}" alt='image' class='imgFluid' loading='lazy'>
                    </a>
                    <div class="blog-card__bookMark-icon">
                        <a href="#">
                            <i class='bx bx-bookmark'></i>
            ...
            <div class="col-md-3">
                <div class="main-blog__card">
                    <a href="{{ route("blog-details") }}" class="blog__card-img">
                        <img src="{{ asset("assets/images//9b26bcd772a85afdbc9d6a3f4cd4180d-madinat-jumeirah.webp") }}" alt='image' class='imgFluid' loading='lazy'>
                    </a>
                    <div class="blog-card__bookMark-icon">
                        <a href="#">
                            <i class='bx bx-bookmark'></i>
...
<div class="newsletter-signup">
    <div class="container">
        <div class="row g-0">
            ...
            <div class="col-md-6">
                <div class="newsletter-signup__content">
                    ...
                    <p>Receive a curated 48-hour itinerary featuring the most iconic experiences in Dubai, straight to your inbox.</p>
        ...
        <div class="communications-subscription__privacy">
            <p>By signing up, you agree to receive promotional emails on activities and insider tips. You can unsubscribe or withdraw your consent at any time with future effect. For more information, read our <a href="#">Privacy statement</a></p>
