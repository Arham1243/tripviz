            ...
            <div class="col-md-12">
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="cart__product">
                            <div class="cart__productImg">
                                <img src="{{ asset("assets/images/Dubai-evening.webp") }}" alt="Product Image" loading="lazy">
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="cart__product">
                            <div class="cart__productImg">
                                <img src="{{ asset("assets/images/Dubai-desert-sky.webp") }}" alt="Product Image" loading="lazy">
                            </div>
                            <div class="cart__productContent">
                                <div>
                                    <div class="cart__productDescription">
