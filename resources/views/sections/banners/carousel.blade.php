@if (!$content)
    <div class="banner-slider">
        <div class="banner banner--overlay">
            <img src="https://i.pinimg.com/736x/4d/50/95/4d50950bd0acdec12c00d579fa7e47b3.jpg" alt="image"
                class="imgFluid banner__bg">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
...
@else
    <div class="banner-slider">
        ...
        @for ($i = 0; $i < 4; $i++)
            @php
                $background_image = $content->background_images[$i];
                $alt_text = $content->alt_text[$i];
            @endphp

            <div class="banner banner--overlay">
                <img data-src="{{ asset($background_image ?? 'admin/assets/images/placeholder.png') }}"
                    alt="{{ $alt_text ?? 'image' }}" class="imgFluid lazy banner__bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="banner-content">
